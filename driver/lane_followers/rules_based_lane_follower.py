...
from lane_followers.lane_follower_utils import display_heading_line, show_image

_SHOW_IMAGE = False


class RulesBasedLaneFollower(object):
    def __init__(self, car):
        logging.info('Creating a rules based lane follower...')
        self.car = car
...
############################
def test_photo(file):
    land_follower = RulesBasedLaneFollower()
...
def test_video(video_file):
    lane_follower = RulesBasedLaneFollower()
